if (!canBounce && bounceNum <= 0) {
	...
	if (oItemManager.hasHeartPendent) {
		...
		copy.tempGhostTimer = 12;
		copy.critShot = critShot;
		array_copy(copy.damageArray, 0, damageArray, 0, array_length(damageArray))
		array_copy(copy.damageTimerArray, 0, damageTimerArray, 0, array_length(damageTimerArray))
		newDir -= 15;
	}
