...
if (ds_list_size(targetList) > 0 && ((keyboard_check(vk_space) or mouse_check_button(mb_left) || oPlayerManager.hasMinionThought)) && array_length(damageArray) < (global.playerFate + global.playerLife)*0.5 - 4) {
	follow = noone;
